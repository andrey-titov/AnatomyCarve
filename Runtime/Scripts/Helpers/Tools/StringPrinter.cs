...
{
    internal class StringPrinterTool : ScriptableObject
    {
        internal static string PrintAntiAliasingSamples()
        {
        ...
        //[MenuItem("Tools/Copy SSAO samples")]
        public static string CopySSAOsamples()
        {
            ...
            {
                Vector2 sample = new Vector4((float)random.NextDouble() - 0.5f, (float)random.NextDouble() - 0.5f, 0, 0);
                sb.AppendLine($"float2({sample.x}, {sample.y}),");
            }
